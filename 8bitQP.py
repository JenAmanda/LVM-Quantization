...
from quant_int8_pytorch import replace_linear_with_pytorch
import Levenshtein
...
# 
# replace_linear_with_pytorch(model, prefix="", exclude_prefixes=["placeHolder"])

replace_linear_with_pytorch(model, prefix="", exclude_prefixes=["lm_head", "model.embed_tokens", "model.visual"])
model.to("cuda")
